      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:items-center lg:py-24 lg:px-8">
        <div>
          ...
          <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
            Hàng nghìn cơ hội việc làm từ các doanh nghiệp uy tín trên khắp Việt
            Nam. Ứng tuyển nhanh chóng, theo dõi trạng thái minh bạch.
          </p>

          <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-border bg-card p-3 shadow-sm sm:flex-row sm:items-center sm:gap-2">
            ...
            <Button size="lg" className="h-11 gap-2 sm:px-6">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
            ...
            {TRENDING_KEYWORDS.map((keyword) => (
              <span
                key={keyword}
                className="rounded-full bg-background px-3 py-1 text-xs font-medium text-foreground ring-1 ring-border"
              >
                {keyword}
              </span>
            ))}
